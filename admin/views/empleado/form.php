<div class="container">
    <form action="empleado.php?action=<?php echo ($action == 'update') ? 'change&id_empleado=' . $datos['id_empleado'] : 'save'; ?>" method="post" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            <label for="Inputempleado" class="form-label">Nombre</label>
            <input type="text" class="form-control" id="Inputempleado" name="nombre" required="required" value="<?php echo (isset($datos["nombre"])) ? $datos["nombre"] : ''; ?>">
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="InputCurp" name="curp" value="<?php echo (isset($datos["curp"])) ? $datos["curp"] : ''; ?>">
        </div>
        <div class="mb-3">
            <label for="InputTelefono" class="form-label">Telefono</label>
            <input type="text" class="form-control" id="InputTelefono" name="telefono" value="<?php echo (isset($datos["telefono"])) ? $datos["telefono"] : ''; ?>">
        </div>
        <div class="mb-3">
            <label for="InputDomicilio" class="form-label">Domicilio</label>
            <input type="text" class="form-control" id="InputDomicilio" name="domicilio" value="<?php echo (isset($datos["domicilio"])) ? $datos["domicilio"] : ''; ?>">
        </div>
        <div class="col-lg-6">
